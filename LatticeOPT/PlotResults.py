...
tot_core_e, tot_core_pd, tot_core_dmd, mean_edge_status = np.zeros([n_itr, 20]), np.zeros([n_itr, 20]), np.zeros(
    [n_itr, 20]), np.zeros([n_itr, 20])
...
plt.xlabel('Design iterations', fontsize=16)
plt.ylabel('Normalized energies [-]', fontsize=16)
plt.legend(['External work, system', 'Minimum compliance design', 'Damage dissipation, system', 'Minimum damage design',
            'Plastic dissipation, system'], fontsize=13)
